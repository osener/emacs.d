...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key interactive-haskell-mode-map (kbd "SPC") 'haskell-mode-contextual-space)
  ...
  (custom-set-faces
   ...
   '(shm-current-face ((t (:background "#dfe4ea")))))
...
#+BEGIN_SRC emacs-lisp
  ...
  (when *is-a-mac*
    ...
    (define-dash-docset 'typescript-mode-hook "js")
