...
#+begin_src emacs-lisp
  ...
  (setq mu4e-drafts-folder "/Ozansener/[Gmail].Drafts")
  (setq mu4e-sent-folder   "/Ozansener/[Gmail].Sent Mail")
  (setq mu4e-trash-folder  "/Ozansener/[Gmail].Trash")

  ;; setup some handy shortcuts
  (setq mu4e-maildir-shortcuts
        '( ("/Ozansener/INBOX"               . ?i)
           ("/Ozansener/[Gmail].Sent Mail"   . ?s)
           ("/Ozansener/[Gmail].Trash"       . ?t)
           ("/Ozansener/[Gmail].All Mail"    . ?a)
           ("/Gmail/INBOX"                   . ?g)))
